...
class UserServiceRcp_Stub;

class UserServiceRcp : public ::google::protobuf::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline UserServiceRcp() {};
 public:
  virtual ~UserServiceRcp();

  typedef UserServiceRcp_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserServiceRcp);
};

class UserServiceRcp_Stub : public UserServiceRcp {
 public:
  UserServiceRcp_Stub(::google::protobuf::RpcChannel* channel);
  UserServiceRcp_Stub(::google::protobuf::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserServiceRcp_Stub);
};
